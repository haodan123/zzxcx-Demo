  ...
  setup(__props) {
    ...
    const dengji = () => {
      common_vendor.index.navigateTo({
        url: "/pagesZhongzhi/nzrukuAdd/nzrukuAdd"
      });
    };
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        h: common_vendor.f(dataList.value, (item, k0, i0) => {
          return {
            ...
            d: common_vendor.t(item.ludeernum || item.deernum || "暂无"),
            e: common_vendor.t(item.ludeernum || item.deernum || "暂无"),
            f: common_vendor.t(item.standardid || "暂无"),
            g: common_vendor.t(item.standardcontent || "暂无"),
            h: common_vendor.t(item.sydrug || "暂无"),
            i: common_vendor.t(item.dosage || "暂无"),
            j: common_vendor.t(item.dosage || "暂无"),
            k: common_vendor.t(item.operator),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/zhiyonghuang/Desktop/未命名文件夹/达州/dzzzjgxcx/pagesZhongzhi/nzruku/nzruku.vue"]]);

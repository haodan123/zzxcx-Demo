...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const dknameList = common_vendor.ref([]);
    ...
    return (_ctx, _cache) => {
      return {
        ...
        e: common_vendor.o(($event) => formData.value.dkname = $event),
        f: common_vendor.p({
          localdata: dknameList.value,
          placeholder: "请选择",
        ...
        o: common_vendor.sr(form, "5c9c13ce-0", {
          "k": "form"
        }),
        p: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/zhiyonghuang/Desktop/未命名文件夹/达州/dzzzjgxcx/pagesZhongzhi/zwchukuAdd/zwchukuAdd.vue"]]);

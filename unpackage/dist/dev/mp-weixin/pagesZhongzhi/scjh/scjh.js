      ...
      return common_vendor.e({
        ...
        e: common_vendor.f(dataList.value, (item, k0, i0) => {
          return {
            ...
            f: common_vendor.t(item.variety || "暂无"),
            g: common_vendor.t(item.weight),
            h: common_vendor.t(item.fnumber || "暂无"),
            i: common_vendor.t(item.mnumber || "暂无"),
            j: common_vendor.t(item.person),
            k: common_vendor.t(item.addtime),
            l: item.id
          };
        })
      });
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/zhiyonghuang/Desktop/未命名文件夹/达州/dzzzjgxcx/pagesZhongzhi/scjh/scjh.vue"]]);

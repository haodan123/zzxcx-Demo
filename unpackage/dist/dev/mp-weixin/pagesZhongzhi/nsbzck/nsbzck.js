  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        j: common_vendor.t(slelectData.value.standardcontent || "暂无"),
        k: common_vendor.p({
          type: "line",
          title: "单价(元):",
          titleFontSize: "16px",
        ...
        l: common_vendor.t(slelectData.value.standardcontent || "暂无"),
        m: common_vendor.p({
          type: "line",
          title: "验收标准:",
          titleFontSize: "16px",
        ...
        n: common_vendor.t(slelectData.value.standardcontent || "暂无"),
        o: common_vendor.p({
          type: "line",
          title: "标准示例:",
          titleFontSize: "16px",
        ...
        p: common_vendor.f(slelectData.value.standardpic, (item, index, i0) => {
          return {
            a: item,
            b: item,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/zhiyonghuang/Desktop/未命名文件夹/达州/dzzzjgxcx/pagesZhongzhi/nsbzck/nsbzck.vue"]]);

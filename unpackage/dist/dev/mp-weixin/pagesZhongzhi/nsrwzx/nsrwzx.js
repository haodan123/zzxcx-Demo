      ...
      return common_vendor.e({
        ...
        e: common_vendor.f(dataList.value, (item, k0, i0) => {
          return common_vendor.e({
            ...
            j: common_vendor.o(($event) => toUrl(1, item), item.id),
            k: common_vendor.o(($event) => toUrl(2, item), item.id)
          }, current.value != 0 ? {
            l: common_vendor.o(openRy, item.id)
          } : {}, {
            m: common_vendor.o(openBz, item.id),
            n: item.id
          });
        }),
        f: current.value != 0,
        ...
        h: common_vendor.sr(popupRy, "db89d4c2-2", {
          "k": "popupRy"
        }),
        i: common_vendor.o(() => {
        }),
        ...
        p: common_vendor.sr(popupBz, "db89d4c2-4", {
          "k": "popupBz"
        }),
        q: common_vendor.o(() => {
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-db89d4c2"], ["__file", "/Users/zhiyonghuang/Desktop/未命名文件夹/达州/dzzzjgxcx/pagesZhongzhi/nsrwzx/nsrwzx.vue"]]);

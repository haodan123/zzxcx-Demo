  ...
  setup(__props) {
    ...
    const dengji = () => {
      common_vendor.index.navigateTo({
        url: "/pagesJiagong/jgchukuAdd/jgchukuAdd"
      });
    };
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        h: common_vendor.f(dataList.value, (item, k0, i0) => {
          return {
            ...
            g: common_vendor.t(item.dosage || "暂无"),
            h: common_vendor.t(item.dosage || "暂无"),
            i: common_vendor.t(item.operator),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/zhiyonghuang/Desktop/未命名文件夹/达州/dzzzjgxcx/pagesJiagong/jgchuku/jgchuku.vue"]]);

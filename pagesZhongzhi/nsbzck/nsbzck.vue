	...
	<view class="viewport">
		...
		<view class="bzHeader">
			...
			<view class="bzItem">
				...
				<view class="select">
					<uni-data-select :clear="false" v-model="mcvalue" :localdata="range1" @change="changeMc"></uni-data-select>
				</view>
			</view>
		</view>
		<!-- 顶部end -->
		...
		<view class="bzContent">
			<view class="contentItem">
				<uni-section type="line" title="标准内容:" titleFontSize="16px" titleFontWeight="bold">
				</uni-section>
				<view class="neirong">
			...
			<view class="contentItem">
				<uni-section type="line" title="计价方式:" titleFontSize="16px" titleFontWeight="bold">
				</uni-section>
				<view class="neirong">
					{{slelectData.standardcontent||'暂无'}}
				</view>
			...
			<view class="contentItem">
				<uni-section type="line" title="单价(元):" titleFontSize="16px" titleFontWeight="bold">
				</uni-section>
				<view class="neirong">
					{{slelectData.standardcontent||'暂无'}}
				</view>
			...
			<view class="contentItem">
				<uni-section type="line" title="验收标准:" titleFontSize="16px" titleFontWeight="bold">
				</uni-section>
				<view class="neirong">
					{{slelectData.standardcontent||'暂无'}}
				</view>

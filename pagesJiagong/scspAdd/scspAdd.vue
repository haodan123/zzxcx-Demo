		...
		<view class="formCard">
			<uni-forms :modelValue="formData" ref="form" label-width='100px' label-align='left'>
				...
				<uni-forms-item label="批次名称:" name="pcname" :rules="[{required: true,errorMessage: '请输入批次名称'}]" required
					style="position: relative;">
					<uni-easyinput type="text" v-model="formData.pcname" disabled placeholder="请输入批次名称" />
				</uni-forms-item>
				<uni-forms-item label="商品名称:" name="spname" :rules="[{required: true,errorMessage: '请输入商品名称'}]" required
					style="position: relative;">
					<uni-easyinput type="text" v-model="formData.spname"  placeholder="请输入商品名称" />
				</uni-forms-item>
				<uni-forms-item label="商品数量:" name="spnum" :rules="[{required: true,errorMessage: '请输入商品数量'}]" required
					style="position: relative;">
					<uni-easyinput type="digit" v-model="formData.spnum"  placeholder="请输入商品数量" />
				</uni-forms-item>
				<uni-forms-item label="商品规格:" name="spguige" :rules="[{required: true,errorMessage: '请输入商品规格'}]" required
					style="position: relative;">
					<uni-easyinput type="text" v-model="formData.spguige"  placeholder="请输入商品规格" />
				</uni-forms-item>
